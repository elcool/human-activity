---
dataMaid: yes
title: Codebook for tidy_averages
subtitle: "Autogenerated data summary from dataMaid"
date: 2019-09-29 00:55:23
 ...
 *  Created by Peter Bangdiwala (username: `pbangdiwala`).

 *  Report creation time: Sun Sep 29 2019 00:55:25

 *  Report was run from directory: `C:/RStudioProjects/C3Project/human-activity`
 ...
 *  Function call: `makeDataReport(data = tidy_averages, mode = c("summarize", "visualize", 
"check"), smartNum = FALSE, file = "codebook_tidy_averages.Rmd", 
    ...
    listChecks = FALSE, maxProbVals = Inf, codebook = TRUE, reportTitle = "Codebook for tidy_averages")`
